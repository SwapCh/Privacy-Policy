...
function PrivacyPolicyPage() {
  return (
    <main className="flex overflow-hidden flex-col bg-white pb-[532px] max-md:pb-24">
      <div className="w-full max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <aside className="w-1/5 max-md:ml-0 max-md:w-full">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/037b15077932d3e9864c14f4970ed28115bc8cea?placeholderIfAbsent=true"
              alt="Agrim Fincap Logo"
              className="object-contain shrink-0 max-w-full aspect-[0.23] shadow-[0px_11px_92px_rgba(15,79,157,0.56)] w-[309px]"
            />
          </aside>
          <div className="ml-5 w-4/5 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col w-full max-md:max-w-full">

              <article className="flex flex-col items-start self-center mt-9 ml-5 max-w-full w-[962px]">
                <img
      ...
      <section className="flex flex-col items-center self-end mt-10 w-full max-w-[1159px] max-md:max-w-full">
        <PolicySection
          ...
          customClasses="self-start ml-28 max-md:ml-2.5"
        />
        ...
        <div className="self-end mt-24 w-full max-w-[1037px] max-md:mt-10 max-md:max-w-full">
          <div className="flex gap-5 max-md:flex-col">
            ...
            <div className="ml-5 w-[28%] max-md:ml-0 max-md:w-full">
              <img
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/fbd5eab8f69bcef45daf41e89111ecc6130a9650?placeholderIfAbsent=true"
                alt="Web Tracking Illustration"
                className="object-contain mt-24 w-full aspect-[0.88] max-md:mt-10"
              />
            </div>
          </div>
        </div>
        ...
        <PolicySection
          ...
          customClasses="self-start ml-32 max-md:ml-2.5"
        />
        ...
        <PolicySection
          ...
          customClasses="self-start ml-36 max-md:ml-2.5"
        />
        ...
        <div className="flex relative flex-col px-16 pt-28 pb-72 mt-12 ml-3.5 max-w-full text-2xl font-semibold leading-none rounded-none min-h-[487px] text-neutral-700 w-[868px] max-md:px-5 max-md:pt-24 max-md:pb-28 max-md:mt-10">
          <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/918fe50241a8a1f6085bc07e6c8693f4999d81c2?placeholderIfAbsent=true"
            alt="Background"
            className="object-cover absolute inset-0 size-full"
          />
